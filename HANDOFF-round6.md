<!-- ARCHIVED by Round 7 (Hammond), 2026-08-08. Superseded by HANDOFF.md.
     Renamed rather than overwritten, per this file's own §0 complaint that
     Round 4's handoff was lost that way. Still load-bearing: §2 (the five
     defects and how each was found), §4 (open work, mostly untouched), §5
     (invariants 10b-20, NOT restated in Round 7), §8 (working with Jake).
     ⚠️ Its §1 version table was already stale when written: it claims admin.js
     v3.24.1 and 11 harnesses; the zip Round 7 received had v3.25.3 and 15. -->
