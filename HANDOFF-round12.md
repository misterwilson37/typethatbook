...
> 📁 **ARCHIVED by Round 13 (Ludlow), 2026-08-18.** Superseded as the current
> handoff by `HANDOFF.md`. **§1, §5 and §7 of this file remain LOAD-BEARING** and
> are cited rather than restated there. §2's version table is superseded:
> `game.js` is v3.23.1, `learn.js` v2.7.1, `session-log.js` v1.1.0.
